...
class Document::California
  include Magick

  def convert_to_pdf(png_page)
  ...
  def write_png(png,outdir,filename)
  ...
  def create_nc110(person, outdir)
  ...
  def create_cm010(person, outdir)
  ...
  def create_nc220(person, outdir)
  ...
  def create_nc230(person, outdir)
  ...
  def send_form_mail(person)
    zip_file = create_zip(person.as_json)
